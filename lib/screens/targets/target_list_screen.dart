...
class _TargetListScreenState extends State<TargetListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // <-- 2. Panggil DashboardProvider untuk ngambil saldo yang paling akurat
    final dashboardProvider = context.watch<DashboardProvider>();
    final saldoTersedia = dashboardProvider.dashboard?.totalWealth ?? 0;
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            formatRupiah(saldoTersedia), // <-- 3. Gunakan saldo dari Dashboard
